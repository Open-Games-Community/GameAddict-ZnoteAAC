...
?>
<h1 style="color:black">Player skills updated!</h1>
<?php
	} else {
		?>
...
?>
<form action="" method="<?php if (!$name) echo "get"; else echo "post";?>" style="width:775px">
		...
		<tr>
			<td colspan="2">
				<?php
					if (!$name) {
						?>
						<center><input class="btn btn-primary" type="submit" value="Fetch character skills info"></center>
						<?php
					} else {
						?>
