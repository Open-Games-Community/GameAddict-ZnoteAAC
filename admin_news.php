...
?>
<h1 style="color:black">News admin panel</h1>
<form action="" method="post" style="width:775px">
	<input type="hidden" name="option" value="a!0"><br></br>
	<input type="submit" value="Create new article"><br></br>
</form>
<?php
// pre stuff
$news = fetchAllNews();
if ($news !== false) {
	?>
	<table id="news" style="width:775px">
		<tr class="yellow">
			<td>Date</td>
			<td>By</td>
			<td>Title</td>
