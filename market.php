...
if (is_array($items) === false):
	?>
	<h1 style="color:black">Marketplace</h1>
...
if (!$compare) {
	...
	?>
	<h1 style="color:balck">Marketplace</h1>
	...
	<form action="" class="market_item_search" style="width:775px">
		<label for="compareSearch">Item search:</label>
		<input type="text" id="compareSearch" name="compare">
		<input type="submit" value="Search">
	</form>
	<h2 style="color:gray">WTS: Want to sell</h2>
	<table class=" tbl-hover" style="width:775px">
		<tr class="yellow">
			<td>Item name</td>
			<td>Item</td>
			<td>Count</td>
	...
	<h2 style="color:gray">WTB: Want to buy</h2>
	<table class=" tbl-hover" style="width:775px">
		<tr class="yellow">
			<td>Item name</td>
			<td>Item</td>
	...
	<h2 style="color:gray">Active offers</h2>
	<table class=" tbl-hover" style="width:775px">
		<tr class="yellow">
			<td>Item name</td>
			<td>Item</td>
	...
	if ($buylist !== false) {
		?>
		<h2 style="color:gray">Want to buy:</h2>
		<table class=" tbl-hover" style="width:775px">
			<tr class="yellow">
				<td>Item name</td>
				<td>Item</td>
	...
	?>
	<h2 style="color:gray">Old purchased offers</h2>
	<table class="tbl-hover" style="width:775px">
		<tr class="yellow">
			<td>Item name</td>
			<td>Item</td>
