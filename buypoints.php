...
<h1 style="color:black">Buy Points</h1>
<h2 style="color:gray">Buy points using Paypal:</h2>
<table id="buypointsTable" class=" table-striped table-hover" style="width:775px">
	<tr class="yellow">
		<th>Price:</th>
		<th>Points:</th>
...
?>
	<h2 style="color:gray">Buy points using Pagseguro:</h2>
	<form target="pagseguro" action="https://<?=hhb_tohtml($pagseguro['urls']['www'])?>/checkout/checkout.jhtml" method="post" style="width:775px">
...
<h2 style="color:gray">Buy points using Paygol:</h2>
<?php $paygol = $config['paygol']; ?>
<p><?php echo $paygol['price'] ." ". hhb_tohtml($paygol['currency']) ."~ for ". $paygol['points'] ." points:"; ?></p>
<form name="pg_frm" method="post" action="http://www.paygol.com/micropayment/paynow" style="width:775px" >
