	...
	if (isset($_GET['u']) && isset($_GET['k'])) {
		...
		if ($auid !== false && $akey !== false) {
			...
			if ($user !== false) {
				...
				echo '<h1 style="color:black">Congratulations!</h1> <p>Your email has been verified.</p>';
				...
				echo '<h1 style="color:black">Authentication failed</h1> <p>Either the activation link is wrong, or your account is already activated.</p>';
			}
		} else {
			echo '<h1 style="color:black">Authentication failed</h1> <p>Either the activation link is wrong, or your account is already activated.</p>';
		}
		...
		switch($action) {
			...
			case 'change_comment':
				...
				if (user_character_account_id($char_name) === $session_user_id) {
					...
					<h1 style="color:black">Change comment on:</h1>
					<form action="" method="post">
						<ul>
							...
							<?php
								...
								Token::create();
							?>
							<br></br><center><input type="submit" value="Update Comment"></center>
						</ul>
					</form>
					<?php
				}
...
if ($render_page) {
	...
	<?php
			...
			?>
			<center style="width:775px"><h4 style="color:red"> Admin Panel </h4>
			<hr>
			
			<div><a href="admin.php" >
				<input id="submit_button" type="submit" value="Admin Page" class="art-button"></a>
				<a href="changelog.php" >
				<input id="submit_button" type="submit" value="Admin Changelog" class="art-button"></a>
			<a href="admin_news.php" >
				<input id="submit_button" type="submit" value="Admin Create News" class="art-button"></a>

			<a href="admin_gallery.php" >
				<input id="submit_button" type="submit" value="Admin Gallery" class="art-button"></a>

			<a href="admin_skills.php" >
			<input id="submit_button" type="submit" value="Admin Skills" class="art-button"></a>
			
			<a href="admin_reports.php" >
				<input id="submit_button" type="submit" value="Admin Reports" class="art-button"></a>
		
			<a href="helpdesk.php" >
				<input id="submit_button" type="submit" value="Admin Tickets" class="art-button"></a>
				

			<a href="admin_shop.php" >
				<input id="submit_button" type="submit" value="Admin Shop" class="art-button"></a>
		
			<a href="admin_auction.php" >
				<input id="submit_button" type="submit" value="Admin Auction" class="art-button"></a>
				<a href="forum.php?cat=4" >
				<input id="submit_button" type="submit" value="Feedback" class="art-button"></a>
</center>
<?php
			}
			// end if admin
	...
	<div id="myaccount">
		...
		<p style="color:black">Welcome to your account page, <?php if ($config['ServerEngine'] !== 'OTHIRE') echo $user_data['name']; else echo $user_data['id']; ?><br>
		...
		?>
		<h2 style="color:gray">Character List: <?php echo $char_count; ?> characters.</h2>
		<?php
		// Echo character list!
		...
		if ($char_array) {
			?>
			<table id="myaccountTable"  style="width:775px">
				<tr class="yellow">
					...
					<tr>
						...
						<td id="submit_form">
							<?php
								...
								Token::create();
							?>
							<input id="submit_button" type="submit" value="Submit" class="art-button"></input>
						</td>
					</tr>
				</table>
			</form>
			...
			<td><a href="createcharacter.php" ><input id="submit_button" type="submit" value="Create Character" >
				</a>

			<td><a href="changepassword.php" >
				<input id="submit_button" type="submit" value="Change Password" ></a>

			<td><a href="settings.php" >
			<input id="submit_button" type="submit" value="Settings" ></a>
			
			<td><a href="logout.php" >
				<input id="submit_button" type="submit" value="Logout" ></a>
		</tr></table>
