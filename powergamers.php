...
?>
<div class="" style="width:775px">
<div class="page-header"><h3 style="color:black">Powergamers</h3></div>
	<?php
	...
	?>
	<form class="form form-inline" action="" method="post" style="width:775px">
		<div class="col sm-4">
			<center>
			...
			<br></br><center><input type="submit" class="btn btn-primary" value="submit"></center><br></br>
	...
	<table class=" table-striped" style="width:775px">
