...
<h1 style="color:black">Server Information</h1>
...
<?php if (($stagesData && isset($stagesData['enabled']) && $stagesData['enabled']) || (isset($luaConfig['experienceStages']) && $luaConfig['experienceStages'] === true)): $stages = true; ?>
	<h2 style="color:black">Server rates</h2>
	<table class="table tbl-hover" style="width:775px">
		<tbody>
			<tr class="yellow">
				<td>Minimum level</td>
				<td>Maximum level</td>
...
<?php if ($luaConfig): ?>
	...
	<h2 style="color:black">Miscellaneous information</h2>
	<table class="table tbl-hover" style="width:775px">
		<tbody>
			<tr class="yellow">
