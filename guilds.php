...
?>
<table id="guildsTable" class=" table-striped table-hover" style="width:775px">
	<tr class="yellow">
		<th>Logo</th>
		<th>Description</th>
		<th>Guild data</th>
...
<br></br>
				<center><input type="submit" value="Create Guild"></center>
			</li>
		</ul>
	</form>
...
<div id="guildTitleDiv" style="width:775px">
...
<table id="guildViewTable" class=" table-striped" style="width:775px">
	<tr class="yellow">
		<th>Rank:</th>
		<th>Name:</th>
		<th>Level:</th>
...
<?php if ($inv_count > 0) { ?>
<h3 style="color:gray">Invited characters</h3>
<table>
	<tr class="yellow">
		<td>Name:</td>
		<?php
...
if ($highest_access >= 2) {
	...
	?>
		...
		?>
			...
			<form action="" method="post" enctype="multipart/form-data" style="width:775px">
				<ul>
		...
		<h2 style="color:black">Guild War Management:</h2>
		<form action="" method="post" style="width:775px">
			<ul>
		...
		<table id="guildsTable" class=" table-striped table-hover" style="width:775px"><tr class="yellow"><th>Aggressor</th><th>Information</th><th>Enemy</th></tr>
		<?php
		$i = 0;
...
if ($config['guildwar_enabled'] === true) {
	...
	if ($war_exist) {
		?>
		<h2 style="color:black">War overview:</h2>
