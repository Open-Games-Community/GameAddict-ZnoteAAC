...
if ($vocGroups) {
	...
	<h1 style="color:black">Ranking for <?php echo skillName($type) .", ". (($vocation === 'all') ? 'any vocation' : vocation_id_to_name($vocation)) ?>.</h1>

	<form action="" method="GET" style="width:775px">
	...
	<table id="highscoresTable" class=" table-striped table-hover" style="width:775px">
