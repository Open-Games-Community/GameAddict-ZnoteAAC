...
<h1 style="color:black">Shop Offers</h1>
<?php
if ($loggedin === true) {
	if (!empty($_POST['buy']) && $_SESSION['shop_session'] == $_POST['session']) {
...
?><br></br>
<div id="categoryNavigator" style="width:775px">
...
<?php if (!empty($category_items)): ?>
	<!-- ITEMIDS -->
	<table class="show table" id="cat_itemids" style="width:775px">
		<tr class="yellow">
			<td>Item:</td>
...
<!-- PREMIUM DURATION -->
<table class="show table" id="cat_premium" style="width:775px">
	<tr class="yellow">
		<td>Description:</td>
		<?php if ($config['shop']['showImage']) { ?><td>Image:</td><?php } ?>
		<td>Duration:</td>
...
<!-- OUTFITS -->
<table class="show table" id="cat_outfits" style="width:775px">
	<tr class="yellow">
		<td>Description:</td>
		<?php if ($config['shop']['showImage']) { ?><td>Image:</td><?php } ?>
		<td>Points:</td>
	...
	<?php foreach ($category_outfits as $key => $offers):
		...
		if (COUNT($offers['itemid']) > 2): ?>
			<tr class="special" style="width:775px">
				<td colspan="2">
...
<!-- MOUNTS -->
<table class="table show" id="cat_mounts" style="width:775px">
	<tr class="yellow" style="width:775px">
		<td>Description:</td>
...
<!-- MISCELLANEOUS -->
<table class="table show" id="cat_misc" style="width:775px">
	<tr class="yellow" style="width:775px">
		<td>Description:</td>
		<?php if ($config['shop']['showImage']) { ?><td>Image:</td><?php } ?>
