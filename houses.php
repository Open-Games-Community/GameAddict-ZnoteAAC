...
if (empty($_POST) === false && $config['ServerEngine'] === 'TFS_03') {
	...
	if (isset($_POST['token']) && Token::isValid($_POST['token'])) {
		...
		if ($array) {
			...
			<div class="well widget" style="width:775px">
				<div class="header">
					Town list / houses
				</div>
				<div class="body">
					<form action="houses.php" method="<?php if ($config['ServerEngine'] !== 'TFS_10') echo "post"; else echo "get" ;?>">
						...
						<?php Token::create(); ?><br></br><center>
						<input type="submit" value="Fetch houses"></center>
					</form>
				</div>
			</div>
			<table id="housesTable" class=" table-striped" style="width:775px">
				<tr class="yellow">
					<th>Name:</th>
					<th>Size:</th>
					<th>Doors:</th>
	...
	if (empty($_POST) === true && $config['ServerEngine'] === 'TFS_03') {
		...
		<div class="well widget" style="width:775px">
			...
			<div class="body" style="width:775px">
				<form action="houses.php" method="<?php if ($config['ServerEngine'] !== 'TFS_10') echo "post"; else echo "get" ;?>">
					<select name="<?php if ($config['ServerEngine'] !== 'TFS_10') echo "selected"; else echo "id" ;?>">
						<?php
						foreach ($config['towns'] as $id => $name)
		...
		if ($house_query !== false && $house_load !== false) {
			?>
			<h2 style="color:gray">House list</h2>
		...
		?>
		<form action="" method="get" class="houselist" style="width:775px">
			<table style="width:775px">
				<tr>
					<td>Town</td>
					<td>Order</td>
				...
				<tr>
					<td colspan="3">
					<br></br><center>
						<input type="submit" value="Fetch houses"/></center><br></br>
					</td>
				</tr>
			</table>
		</form>
		...
		if ($houses !== false || !empty($houses)) {
			...
			?>
			<table id="housetable" style="width:775px">
				<tr class="yellow">
					<th>Name</th>
					<th>Size</th>
					<th>Beds</th>
