...
<h1 style="color:black">Character Auction History</h1>
...
<?php data_dump($config['shop_auction'], false, "config.php: shop_auction") ?></div>
<h2 style="color:black">Pending orders to be claimed</h2>
<?php if ($pending !== false): ?>
	<table class="auction_char" style="width:775px">
		<tr class="yellow">
			<td>Player</td>
			<td>Level</td>
			<td>Vocation</td>
...
<h2 style="color:black">Ongoing auctions</h2>
...
<h2 style="color:black">Completed auctions</h2>
<?php
if ($completed !== false): ?>
	<table class="auction_char" style="width:775px">
		<tr class="yellow">
