...
?><h1 style="color:black">Images in need of moderation:</h1><?php
...
if ($images != false) {
	...
	<?php }
} else echo '<h2 style="color:gray">All good, no new images to moderate.</h2>';

?><h1 style="color:black">Public Images:</h1><?php
$images = fetchImages(2);
if ($images != false) {
	foreach($images as $image) {
		?>
	...
	<?php }
} else echo '<h2 style="color:gray">There are currently no public images.</h2>';

?><h1 style="color:black">Deleted Images:</h1><?php
...
if ($images != false) {
	...
	<?php }
} else echo '<h2 style="color:gray">There are currently no deleted images.</h2>';
// end
