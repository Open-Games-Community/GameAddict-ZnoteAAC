...
if (isset($_GET['success']) && empty($_GET['success'])) {
	...
	if ($user !== false) {
		...
		echo '<h1>Congratulations!</h1> <p>Your account has been created. You may now login to <a href="createcharacter.php">create a character</a>.</p>';
	} else {
	...
	<form action="" method="post" style="width:775px">
		<ul>
			...
			?>
				...
				<h2 style="color:black">Server Rules</h2>
